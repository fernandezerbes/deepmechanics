...
class Functional:
    ...
    def __init__(self, integrator=gauss_legendre_integration, *neumann_bcs, source_function=None):
...
class PotentialEnergyFunctional(Functional):
    ...
    def __init__(self, integrator=gauss_legendre_integration, neumann_bcs=None, source_function=None):
    ...
    def external_term(self, approximator):
        ...
        for bc in self.neumann_bcs:
            if bc is not None:
                ...
                result += self.integrator(integrand, bc.boundary_weights, bc.boundary_jacobian_dets)
