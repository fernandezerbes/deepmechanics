...
class DirichletBoundaryCondition:
    ...
    def get_constraint_on_top_edge(self):
        def constraint(ux, uy):
            return self._constraint_function(self._top_edge_integration_point_coords, ux, uy)
        return constraint

    def get_constraint_on_bottom_edge(self):
        def constraint(ux, uy):
            return self._constraint_function(self._bottom_edge_integration_point_coords, ux, uy)
        return constraint

    def get_constraint_on_right_edge(self):
        def constraint(ux, uy):
            return self._constraint_function(self._right_edge_integration_point_coords, ux, uy)
        return constraint

    def get_constraint_on_left_edge(self):
        def constraint(ux, uy):
            return self._constraint_function(self._left_edge_integration_point_coords, ux, uy)
        return constraint
...
class FixedDisplacementsOnTopEdge(DirichletBoundaryCondition):
    ...
    def __init__(self, grid):
        super().__init__(grid)
        self._constraint_function = lambda ys, ux, uy: (ux * (grid.length_y - ys), uy * (grid.length_y - ys))
        ...
        self._bottom_edge_integration_point_coords = grid.bottom_edge_integration_point_ys
...
class FixedDisplacementsOnRightEdge(DirichletBoundaryCondition):
    ...
    def __init__(self, grid):
        super().__init__(grid)
        self._constraint_function = lambda xs, ux, uy: (ux * (grid.length_x - xs), uy * (grid.length_x - xs))
        ...
        self._bottom_edge_integration_point_coords = grid.bottom_edge_integration_point_xs
...
class NeumannBoundaryCondition:
    ...
    def __init__(self, load_function, boundary_data, constraint):
        ...
        self.boundary_coords, self.boundary_weights, self.boundary_jacobian_dets = boundary_data
